...
import { Search, Clock, BookOpen, Heart, Printer, Play, Pause, RotateCcw } from "lucide-react"
...
export default function WorkoutGuide() {
  const [exercises] = useState<Exercise[]>([
    // Upper Body - Chest
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/06b6d4?text=Bench+Press",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/8b5cf6?text=Push+Ups",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/ec4899?text=Dumbbell+Flyes",
      gifAlt:
    ...
    // Upper Body - Back
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/10b981?text=Pull+Ups",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/f59e0b?text=Barbell+Row",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/3b82f6?text=Lat+Pulldown",
      gifAlt:
    ...
    // Upper Body - Shoulders
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/ef4444?text=Overhead+Press",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/a855f7?text=Lateral+Raises",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/06b6d4?text=Face+Pulls",
      gifAlt:
    ...
    // Upper Body - Arms
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/8b5cf6?text=Barbell+Curls",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/ec4899?text=Tricep+Dips",
      gifAlt:
    ...
    // Core
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/10b981?text=Plank",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/f59e0b?text=Russian+Twists",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/3b82f6?text=Dead+Bug",
      gifAlt:
    ...
    // Lower Body
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/ef4444?text=Back+Squat",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/a855f7?text=Romanian+DL",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/06b6d4?text=Bulgarian+Split",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/8b5cf6?text=Hip+Thrust",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/ec4899?text=Calf+Raises",
      gifAlt:
    ...
    // Full Body Compound
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/10b981?text=Burpees",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/f59e0b?text=Deadlift",
      gifAlt:
    ...
    },
    {
      ...
      gifUrl: "https://placehold.co/400x400/1f2937/3b82f6?text=Thrusters",
      gifAlt:
  ...
  }, [searchTerm, selectedMuscleGroup, selectedDifficulty, exercises])
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 mb-8">
          <div className="flex flex-col md:flex-row items-center justify-between">
            <div className="flex items-center space-x-4 mb-4 md:mb-0">
              ...
              <span className="text-2xl font-mono font-bold text-white">{formatTime(timerSeconds)}</span>
            </div>
        ...
        <div className="bg-gray-800/50 backdrop-blur-sm rounded-2xl p-6 border border-gray-700 mb-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="flex items-center justify-center bg-gray-700/50 rounded-lg px-4 py-3">
              <span className="text-gray-300">{filteredExercises.length} exercises</span>
            </div>
          </div>
        </div>
          ...
          {filteredExercises.map((exercise) => (
            ...
            >
              ...
              <div className="relative">
                ...
                >
                  <Heart className={`h-5 w-5 ${favorites.includes(exercise.id) ? "fill-current" : ""}`} />
                </button>
              ...
              <div className="p-6">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-cyan-500 to-purple-600 hover:from-cyan-600 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg transition-all duration-300 flex items-center justify-center"
                >
